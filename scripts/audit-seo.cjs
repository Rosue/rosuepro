...
const routes = ['/', '/portfolio', '/resume', '/blog', '/blog/basic-tips-market-music', '/blog/pack-my-cart-helps-jamaican-supermarkets', '/blog/websites-and-ai-for-jamaican-salons-barbershops', '/blog/websites-and-ai-for-jamaican-restaurants-cookshops', '/about-us'];
